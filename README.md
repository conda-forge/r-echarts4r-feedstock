About r-echarts4r-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-echarts4r-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2442&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-echarts4r-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-echarts4r` can be installed with `conda`:
...
```
mamba install r-echarts4r
```

It is possible to list all of the versions of `r-echarts4r` available on your platform with `conda`:
...
```
mamba search r-echarts4r --channel conda-forge
```
...
mamba repoquery search r-echarts4r --channel conda-forge

# List packages depending on `r-echarts4r`:
mamba repoquery whoneeds r-echarts4r --channel conda-forge

# List dependencies of `r-echarts4r`:
mamba repoquery depends r-echarts4r --channel conda-forge
```
